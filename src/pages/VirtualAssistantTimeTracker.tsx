import { ArrowLeft, ArrowRight, Check, Trophy, Headset, Clock, Briefcase, Export, CalendarBlank, UsersThree } from "@phosphor-icons/react";
        ...
        <div className="container">
          ...
          <div className="glass rounded-3xl p-8 md:p-12 mb-20 border border-teal-500/20 bg-gradient-to-br from-teal-500/5 to-transparent max-w-4xl mx-auto">
            ...
            <p className="text-zinc-300 leading-relaxed mb-6">
              <strong className="text-white">timedigits</strong> is ideal for VAs who juggle multiple clients:
            </p>
            <ul className="space-y-3 text-zinc-300">
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-400 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-white">Free forever</strong> — unlimited clients and hours</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-400 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-white">Multi-client tracking</strong> — switch clients with one click</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-400 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-white">Per-client reports</strong> — generate invoices for each client</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-400 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-white">CSV export</strong> — works with any invoicing tool</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-400 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-white">No surveillance</strong> — track time, not screenshots</span>
              </li>
            </ul>
          </div>
          ...
          <section className="mb-20 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="glass rounded-2xl p-6">
                <h3 className="text-white font-semibold mb-2">What's the best time tracker for virtual assistants?</h3>
              ...
              <div className="glass rounded-2xl p-6">
                <h3 className="text-white font-semibold mb-2">Is timedigits free for VAs?</h3>
                <p className="text-zinc-400">
              ...
              <div className="glass rounded-2xl p-6">
                <h3 className="text-white font-semibold mb-2">How do I track time for different clients?</h3>
                <p className="text-zinc-400">
              ...
              <div className="glass rounded-2xl p-6">
                <h3 className="text-white font-semibold mb-2">Can I track against retainer hours?</h3>
                <p className="text-zinc-400">
              ...
              <div className="glass rounded-2xl p-6">
                <h3 className="text-white font-semibold mb-2">Does timedigits work on mobile?</h3>
                <p className="text-zinc-400">
          ...
          <section className="text-center max-w-2xl mx-auto">
            <div className="glass rounded-3xl p-8 md:p-12 border border-teal-500/20">
              <Headset size={48} className="text-teal-400 mx-auto mb-6" />
