  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen bg-white pt-28">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {featuredPosts.map((post, index) => (
                <motion.article
                  ...
                  className="bg-white rounded-2xl p-6 border border-slate-200 hover:border-teal-300 hover:shadow-lg transition-all group"
                >
                  <div className="flex items-center gap-2 text-xs text-teal-600 mb-3">
                  ...
                  <Link
                    to={`/blog/${post.slug}`}
                    className="text-teal-600 text-sm flex items-center gap-1 hover:gap-2 transition-all font-medium"
                  >
        ...
        {/* Search and Filter */}
        <section className="py-8 border-b border-slate-200 sticky top-20 bg-white/95 backdrop-blur-sm z-10">
          <div className="container max-w-6xl">
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              ...
              <div className="relative w-full md:w-80">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-white border border-slate-300 rounded-lg text-slate-800 placeholder-slate-400 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 focus:outline-none transition-colors"
                />
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {filteredPosts.map((post, index) => (
                  <motion.article
                    ...
                    className="bg-white rounded-xl p-6 border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all group"
                  >
