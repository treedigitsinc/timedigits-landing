import { ArrowRight, Check, Trophy, Blueprint, Clock, Briefcase, Export, Buildings, PencilRuler } from "@phosphor-icons/react";
        ...
        <div className="container">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 mb-20 border border-teal-500/20 shadow-sm max-w-4xl mx-auto">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              <strong className="text-slate-900">timedigits</strong> is ideal for architects who need
              simple, affordable time tracking:
            </p>
            <ul className="space-y-3 text-slate-600">
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Free for solo architects</strong> — unlimited projects and clients</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Phase tracking</strong> — organize time by SD, DD, CD, CA</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Project-based organization</strong> — track multiple buildings/clients</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
              ...
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">CSV export</strong> — for client invoicing and reporting</span>
              </li>
            </ul>
          </div>
          ...
          <section className="mb-20 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">What's the best time tracker for architects?</h3>
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Is timedigits free for solo architects?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Can I track time by project phase?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">How much does it cost for an architecture firm?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Does it integrate with Revit or AutoCAD?</h3>
                <p className="text-slate-600">
          ...
          <section className="text-center max-w-2xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-12 border border-teal-500/20 shadow-sm">
              <Blueprint size={48} className="text-teal-500 mx-auto mb-6" />
