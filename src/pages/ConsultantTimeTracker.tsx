import { ArrowRight, Check, Trophy, Briefcase, CurrencyDollar, Clock, Export, ChartLine, CalendarBlank } from "@phosphor-icons/react";
        ...
        <div className="container">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 mb-20 border border-teal-500/20 shadow-sm max-w-4xl mx-auto">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              <strong className="text-slate-900">timedigits</strong> is the best free time tracker for consultants
            ...
            <ul className="space-y-3 text-slate-600">
              <li className="flex items-start gap-3">
                ...
                <span><strong className="text-slate-900">100% free</strong> — unlimited clients, projects, and time entries</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Client workspaces</strong> — organize time by client for clean billing</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">CSV export</strong> — invoice-ready reports for any billing system</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Works offline</strong> — track time during client meetings, on planes, anywhere</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Mobile apps</strong> — track from your phone during site visits</span>
              </li>
            </ul>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {workflows.map((workflow) => (
                <div key={workflow.title} className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                  <h3 className="text-slate-900 font-semibold mb-4">{workflow.title}</h3>
          ...
          <section className="mb-20 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">What's the best time tracker for consultants?</h3>
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Is timedigits really free for consultants?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Can I track different hourly rates per client?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">What if I grow into a consulting firm?</h3>
                <p className="text-slate-600">
