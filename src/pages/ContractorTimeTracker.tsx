import { ArrowRight, Check, Trophy, Hammer, Clock, Briefcase, Export, HardHat, Truck } from "@phosphor-icons/react";
        ...
        <div className="container">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 mb-20 border border-teal-500/20 shadow-sm max-w-4xl mx-auto">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              <strong className="text-slate-900">timedigits</strong> is ideal for contractors who need
            ...
            <ul className="space-y-3 text-slate-600">
              <li className="flex items-start gap-3">
                ...
                <span><strong className="text-slate-900">Free for solo contractors</strong> — unlimited jobs and hours</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Works offline</strong> — track time on remote sites without cell service</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Mobile apps</strong> — track from your phone on the job site</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">$1/user for crews</strong> — affordable team tracking</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-500 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">CSV export</strong> — for invoicing and payroll</span>
              </li>
            </ul>
          </div>
          ...
          <section className="mb-20 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">What's the best time tracker for contractors?</h3>
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Does it work without cell service?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Can I track my crew's hours?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">How much does it cost for a crew?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Can I export for payroll?</h3>
                <p className="text-slate-600">
          ...
          <section className="text-center max-w-2xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-12 border border-teal-500/20 shadow-sm">
              <Hammer size={48} className="text-teal-500 mx-auto mb-6" />
