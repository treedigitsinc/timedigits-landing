import { ArrowRight, Check, Trophy, Heart, Clock, Briefcase, Export, CalendarBlank, ShieldCheck } from "@phosphor-icons/react";
        ...
        <div className="container">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-white rounded-3xl p-8 md:p-12 mb-20 border border-teal-200 max-w-4xl mx-auto">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              <strong className="text-slate-900">timedigits</strong> is ideal for mental health professionals
            ...
            <ul className="space-y-3 text-slate-600">
              <li className="flex items-start gap-3">
                ...
                <span><strong className="text-slate-900">Free for solo practice</strong> — unlimited clients and sessions</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-600 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Privacy-focused</strong> — no screenshots, no surveillance</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-600 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Session tracking</strong> — log therapy, consultation, and admin time</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-600 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">CSV export</strong> — for billing and insurance claims</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-teal-600 mt-0.5 flex-shrink-0" weight="bold" />
                <span><strong className="text-slate-900">Simple interface</strong> — focus on clients, not software</span>
              </li>
            </ul>
          ...
          <section className="mb-20 max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">What's the best time tracker for therapists?</h3>
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Is timedigits HIPAA compliant?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Can I use this for insurance documentation?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">Is it free for solo therapists?</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                <h3 className="text-slate-900 font-semibold mb-2">How much for a group practice?</h3>
                <p className="text-slate-600">
