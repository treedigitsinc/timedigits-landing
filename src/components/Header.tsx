...
export function Header() {
  ...
  const navLinks = [
    ...
    { name: "Compare", href: "/compare", isHash: false },
    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            href="https://app.timedigits.ca/login"
            className="bg-teal-500 text-white hover:bg-teal-600 transition-colors px-5 py-2.5 rounded-full text-sm font-semibold"
          >
            Start Free
          </a>
        </div>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-slate-200 p-6 flex flex-col gap-6 shadow-lg">
